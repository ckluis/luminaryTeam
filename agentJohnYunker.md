...
- **FINDINGS**: Numbered list, each citing specific strings, formats, locales, or cultural assumptions; each finding carries a direct quote (≤20 words) from the artifact and a proposed priority (P0–P3)
